angular.module('app')
        .controller('contact_requestController', contact_requestController);

contact_requestController.$inject = ['$scope', '$state', '$rootScope', 'APIURL', '$http', 'ApiService']

function contact_requestController($scope, $state, $rootScope, APIURL, $http, ApiService) {
    ...
    $scope.totalItems = [];
    ApiService.hm_contact_request().then(function(res){
