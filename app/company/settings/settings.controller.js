...
companySettingsController.$inject = ['$scope', '$state', '$rootScope', 'APIURL', '$http', 'ApiService']

function companySettingsController($scope, $state, $rootScope, APIURL, $http, ApiService) {
